...
# Selected
selected = sorted([c.lower() for c in
                  ['alb', 'alt', 'baso', 'bil', 'cl', 'cre', 'crp', 'egfr',
                   'eos', 'hct', 'hgb', 'k', 'ly', 'mch', 'mchc', 'mcv',
                   'mono', 'mpv', 'neut', 'nrbca', 'plt', 'rbc', 'rdw',
                   'urea', 'wbc', 'sodium', 'alp']])
...
# ------------------------------------
# Complete dataframe (auxiliary)
complete = data.dropna(how='any', subset=selected)
...
dataframe['count_complete'] = complete.count()
dataframe['count_complete_covid'] = complete[complete['covid_confirmed']].count()
dataframe['count_complete_micro'] = complete[complete['micro_confirmed']].count()
